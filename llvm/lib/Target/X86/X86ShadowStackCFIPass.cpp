...
namespace {
    ...
    private:
        int count = 0;  //runonmachinefunctionfunc
        struct MBBNode
        {
            string MBBNodeName; //
    ...
    public:
        ...
        //ModuleCFGdot,runOnMachineFunction
        ...
        //shadowstackretss0x2FFFFFFFFFFFFFFF
